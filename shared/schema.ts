...
export const licenses = sqliteTable("licenses", {
  ...
  type: text("type", { enum: ["pharmacist_license", "dea", "npi", "pharmacy_permit", "controlled_substance", "telehealth_license", "professional_liability_insurance", "form_1099", "other_certifications", "ncpdp", "pharmacy_dea", "pharmacy_npi", "pharmacy_license", "pic_number", "prescriber_npi", "prescriber_dea", "prescriber_professional_license"] }).notNull(),
